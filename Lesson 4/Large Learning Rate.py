...
def train_model_with_real_time_plot(model, x_train, y_train, num_epochs=10000, learning_rate=0.4):
    ...
    ax.set_xlabel('x')
    ax.set_ylabel('y')
    ax.set_title(f'Supervised Learning Fit: Gradient Descent Big Step')
    ax.legend()
